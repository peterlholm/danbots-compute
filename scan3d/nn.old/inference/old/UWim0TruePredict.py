...
def load_H_model():
    ...
    model = tensorflow.keras.models.load_model('/home/samir/dbpro/cnnpredict/models/UN15models/im0wr40.h5')
    return(model)
# /home/samir/dblive/cnnpredict/models/cnnres01-220-modelwrap1'+'-200-adam-noBN.h5

def load_L_model():
    model = tensorflow.keras.models.load_model('/home/samir/dbpro/cnnpredict/models/UN15models/wr1uw-50.h5')
    return(model)
...
def newDepth(folder, basecount):
    ...
    DBase = np.load(basefile)
    unwrap = np.load(folder+'nnunwrap.npy' )/3
    mask = np.load(folder+'mask.npy' )
    # print('DBase:', np.amax(DBase), np.amin(DBase))
    # print('unwrap:', np.amax(unwrap), np.amin(unwrap))
...
folder = '/home/samir/Desktop/blender/pycode/bldev2/scans/cscans/render'
bfolder = '/home/samir/Desktop/blender/pycode/bldev2/scans/cscans/'
...
for i in range(20):#  (len(os.listdir(bfolder))):
    i = i+offset
